...
# ╔═╡ 49139b59-b61a-4804-bd64-1ef624082107
using PlutoUI

# ╔═╡ f7137fd2-e2a3-11ed-34dc-1f4427ef1730
using KomaMRI, WebIO

# ╔═╡ 802cd04a-4c46-4264-a5d9-c4ed9b296e60
using Plots, PlotlyJS, GR, PyPlot, PlotlyBase

# ╔═╡ 94c4daf5-cc81-48af-b3f4-c7525034c7ef
plotly()

# ╔═╡ cb430aec-5f0f-4d92-8a00-eead7ef97726
begin	
	# SCANNER #
	sys = Scanner()
...
# ╔═╡ d7e5e06c-7201-48aa-81f8-ed895bd80a31
# PHANTOM #
obj = Phantom{Float64}(x = [0.], T1 = [1000e-3], T2 = [100e-3]);

# ╔═╡ e570b671-adfc-4fbc-b325-f32fa1f71411
obj

# ╔═╡ 2b244a86-45b3-4825-9169-4eb8ce28c296
p1 = plot_phantom_map(obj, :Δw; height = 400, darkmode=false)

# ╔═╡ fb580afd-9ac2-468d-acdc-f0dd034c4246
display(p1)
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "7b90aefd3ac64324af1ac3510c7261622a7e685d"
...
[[deps.KomaMRI]]
deps = ["Adapt", "AssetRegistry", "Blink", "CUDA", "Distributed", "FileIO", "Functors", "HDF5", "Interact", "Interpolations", "JLD2", "LinearAlgebra", "MAT", "MRIFiles", "MRIReco", "Parameters", "Pkg", "PlotlyJS", "ProgressMeter", "Random", "Reexport", "Scanf", "ThreadsX"]
git-tree-sha1 = "7af2119cac3b6684f658a78ec3918909a48dfb84"
...
git-tree-sha1 = "0dc5b02b1bf842e65e6a8ac849e0a424143788c4"
...
deps = ["FLoops", "IterativeSolvers", "LinearAlgebra", "LinearOperators", "ProgressMeter", "Random", "SparseArrays", "StatsBase", "VectorizationBase"]
git-tree-sha1 = "dbdaf7f98d3c15bd1d3743032698201eb9fb5bf5"
